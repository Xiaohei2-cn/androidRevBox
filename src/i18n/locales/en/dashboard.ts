...
export default {
  ...
  "dashboard.foreground.readOnDemand": "not read (use the arrow to read on demand; maps needs root)",
  "dashboard.foreground.viewDetail": "View details",
  "dashboard.foreground.detailBack": "Back",
  "dashboard.foreground.detailLoading": "reading…",
  "dashboard.foreground.detailLines": "{total} lines in total, showing {shown} · {via}",
  "dashboard.foreground.detailLinesTruncated": "{total} lines in total, showing {shown} (truncated) · {via}",
  "dashboard.foreground.detailViaRoot": "read as root",
  "dashboard.foreground.detailViaShell": "read as shell",
  "dashboard.foreground.detailFailed": "read failed",
