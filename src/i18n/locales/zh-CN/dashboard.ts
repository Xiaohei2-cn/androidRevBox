...
export default {
  ...
  "dashboard.foreground.readOnDemand": "未读取（点右侧箭头按需读取，maps 需要 root）",
  "dashboard.foreground.viewDetail": "查看详情",
  "dashboard.foreground.detailBack": "返回",
  "dashboard.foreground.detailLoading": "读取中…",
  "dashboard.foreground.detailLines": "共 {total} 行，本次显示 {shown} 行 · {via}",
  "dashboard.foreground.detailLinesTruncated": "共 {total} 行，本次显示 {shown} 行（已截断）· {via}",
  "dashboard.foreground.detailViaRoot": "以 root 读取",
  "dashboard.foreground.detailViaShell": "以 shell 读取",
  "dashboard.foreground.detailFailed": "读取失败",
