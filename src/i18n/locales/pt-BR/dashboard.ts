...
export default {
  ...
  "dashboard.tool.appMissing": "{name} não instalado",
  "dashboard.tool.mcpLabel": "MCP",
  "dashboard.tool.mcpOnline": "MCP online",
  "dashboard.tool.mcpOffline": "MCP desligado",
  ...
  "dashboard.foreground.readOnDemand": "não lido (use a seta para ler sob demanda; maps exige root)",
  "dashboard.foreground.viewDetail": "Ver detalhes",
  "dashboard.foreground.detailBack": "Voltar",
  "dashboard.foreground.detailLoading": "lendo…",
  "dashboard.foreground.detailLines": "{total} linhas no total, exibindo {shown} · {via}",
  "dashboard.foreground.detailLinesTruncated": "{total} linhas no total, exibindo {shown} (truncado) · {via}",
  "dashboard.foreground.detailViaRoot": "lido como root",
  "dashboard.foreground.detailViaShell": "lido como shell",
  "dashboard.foreground.detailFailed": "falha ao ler",
