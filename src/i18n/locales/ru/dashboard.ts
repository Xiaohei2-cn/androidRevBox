...
export default {
  ...
  "dashboard.foreground.readOnDemand": "не читалось (стрелка — прочитать по требованию; maps требует root)",
  "dashboard.foreground.viewDetail": "Показать подробно",
  "dashboard.foreground.detailBack": "Назад",
  "dashboard.foreground.detailLoading": "чтение…",
  "dashboard.foreground.detailLines": "всего {total} строк, показано {shown} · {via}",
  "dashboard.foreground.detailLinesTruncated": "всего {total} строк, показано {shown} (обрезано) · {via}",
  "dashboard.foreground.detailViaRoot": "прочитано как root",
  "dashboard.foreground.detailViaShell": "прочитано как shell",
  "dashboard.foreground.detailFailed": "не удалось прочитать",
