...
export default {
  ...
  "settings.clickThrough.hint":
    "Когда включено, клики по по-настоящему прозрачным местам (промежутки между карточками, поля, вне скруглённых углов) уходят в приложение позади этого окна. Карточки, кнопки, поля ввода и текст по-прежнему принадлежат этому инструменту. Строка заголовка и панель вкладок остаются кликабельными всегда — можно вернуться сюда и выключить.",
