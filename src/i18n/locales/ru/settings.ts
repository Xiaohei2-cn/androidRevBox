...
export default {
  ...
  "settings.clickThrough.hint":
    "Когда включено, клики уходят позади окна только в двух местах панели вкладок слева: прозрачное поле слева от «зубцов» и полупрозрачное тело неактивной вкладки. Промежутки между вкладками, области попадания по иконкам, активная вкладка и вся область контента по-прежнему принимают клики. Внешние 12px каждой границы окна остаются зоной изменения размера — размер можно менять всегда. Текущее состояние показано ниже.",
