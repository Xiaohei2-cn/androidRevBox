...
export default {
  ...
  "settings.clickThrough.hint":
    "Когда включено, клики уходят позади окна ровно в одном месте: прозрачное поле слева от каждой вкладки. Тело вкладки, иконка, промежутки между вкладками, активная вкладка и весь контент по-прежнему принимают клики — нажать на вкладку это базовая операция, она не должна проваливаться. Внешние 12px каждой границы остаются зоной изменения размера. Текущее состояние показано ниже.",
