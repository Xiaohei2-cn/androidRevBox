...
export default {
  ...
  "dashboard.foreground.readOnDemand": "未読（矢印で必要時に読みます。maps は root が必要）",
  "dashboard.foreground.viewDetail": "詳細を表示",
  "dashboard.foreground.detailBack": "戻る",
  "dashboard.foreground.detailLoading": "読み込み中…",
  "dashboard.foreground.detailLines": "全 {total} 行中 {shown} 行表示 · {via}",
  "dashboard.foreground.detailLinesTruncated": "全 {total} 行中 {shown} 行表示（省略あり）· {via}",
  "dashboard.foreground.detailViaRoot": "root で読み取り",
  "dashboard.foreground.detailViaShell": "shell で読み取り",
  "dashboard.foreground.detailFailed": "読み取り失敗",
