...
export default {
  ...
  "settings.clickThrough.hint":
    "オンにしても後ろのアプリにクリックを渡すのは左タブバーの2箇所だけです：タブ左側の透明な余白と、未選択タブの半透明部分。タブ間の隙間、アイコンのヒット領域、選択中のタブ、コンテンツ領域はすべてクリックを受け取ります。ウィンドウ四辺の外侧12pxは常にリサイズ用のつかみ領域なのでサイズ変更も可能。現在の状態は下のライブ表示に出ます。",
